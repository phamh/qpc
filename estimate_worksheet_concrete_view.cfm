...
<div style="width:98%; border:0px dotted black" align=center>
	<table style="border-collapse:collapse; border:2px solid black; text-align:left; margin-top:20px">
		<!---HEADERS --->
		<tr bgcolor=lightGrey>
			<th style="border:1px solid black;padding:5px; text-align:center; color:orange; background-color:#0000a0;"><cfoutput>View #url.worksheetId#</cfoutput></th>
	...
	<cfoutput>
		<input type="button" onclick="editThisWorksheet(<cfoutput>'#url.worksheetId#', '#url.estimateId#'</cfoutput>)" value="Edit #url.worksheetId#" class="buttonsmall">
	</cfoutput>
</div>	
</cfif>
...
<div align=center style="border:2px solid black; width:1000px; height:900px;padding:5px">
		...
		<table border=0 style="width:#tableWidth#">
        	<td style="width:300px">
				<input type="button" value="Submit" class="buttonsmall" onclick="submitNewEstimate();//selectThisMenu('currentRow_2', 'currentRow_1', preRowBgColor);">
	...
	<table style="width:<cfoutput>#tableWidth#</cfoutput>; border-collapse:collapse;border:0px solid black; margin-bottom:20px">
		...
		<tr>
			...
			<td style="border:#borderWidth# solid black">		
				<input type="text" id="estimateDate"  name="estimateDate" value="#dateFormat(now(), 'MMM-dd-yyyy')#" readOnly size="13" onClick="return showCalendar2('estimateDate', 'btnEstimateDate','', 1); changeExpiredDate()" >
